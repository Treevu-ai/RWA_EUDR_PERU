...
const LOG_LINES = [
  "> Inicializando pipeline IA...",
  "> Cargando pesos del modelo: 2.4GB",
  "> Conectando al flujo de datos...",
  "> Analizando base de código...",
  "> Ejecutando inferencia: lote_01",
  "> Paso de optimización: 1/3",
  "> Paso de optimización: 2/3",
  "> Paso de optimización: 3/3",
  "> 98% Optimizado",
  "> Desplegando en nodos edge...",
  "> Estado: OPERACIONAL",
  "> Latencia: 12ms p99",
  "> Throughput: 14.2k req/s",
  "> Memoria: 847MB / 2048MB",
  "> --------- CICLO COMPLETO ---------",
]
