  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col justify-center gap-6 p-6">
        <ScrambleNumber target="4.2ms" label="Latencia Prom." delay={500} />
        <ScrambleNumber target="12.8K" label="Peticiones / seg" delay={800} />
        <ScrambleNumber target="99.97%" label="Disponibilidad" delay={1100} />
        <ScrambleNumber target="147" label="Modelos Activos" delay={1400} />
      </div>
    </div>
  )
}
