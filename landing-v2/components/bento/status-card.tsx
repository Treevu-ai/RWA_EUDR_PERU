...
const REGIONS = [
  { name: "SA-EAST-1", status: "ONLINE", latency: "3.2ms" },
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col p-4 gap-0">
        ...
        <div className="grid grid-cols-3 gap-2 border-b border-border pb-2 mb-2">
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground">Región</span>
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground">Estado</span>
          <span className="text-[9px] tracking-[0.15em] uppercase text-muted-foreground text-right">Latencia</span>
        </div>
        {REGIONS.map((region) => (
          <div
            key={region.name}
