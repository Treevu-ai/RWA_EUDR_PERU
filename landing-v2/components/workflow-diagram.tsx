...
const LEFT_LABELS = ["Entrenar", "Empaquetar", "Versionar"]
const RIGHT_LABELS = ["Enrutar", "Desplegar", "Monitorear"]
  ...
  return (
    <div className="relative w-full max-w-[800px] mx-auto">
      <svg
        ...
        role="img"
        aria-label="Diagrama de flujo mostrando etapas de despliegue: Entrenar, Empaquetar, Versionar, Enrutar, Desplegar, Monitorear"
      >
