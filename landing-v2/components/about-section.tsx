...
/* ── stat block ── */
const STATS = [
  { label: "MODELOS_ACTIVOS", value: "147" },
  { label: "REGIONES_EDGE", value: "50+" },
  { label: "LLAMADAS_INFERENCIA", value: "12.8B" },
  { label: "LATENCIA_PROM", value: "4.2ms" },
]
          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                ...
                <br />
                <span className="text-[#ea580c]">inteligencia pura</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Ingeniamos la capa base que se sitúa entre tus modelos
                  y tus usuarios. Sin abstracciones. Sin magia. Solo enrutamiento
                  determinístico, inferencia sub-5ms, y control operacional
                  transparente en cada nodo edge de la red.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Fundado por ingenieros de sistemas con una década construyendo
                  cómputo distribuido a hiperescala. Creemos que la infraestructura IA
                  debe ser inspeccionable, auditable y brutalmente rápida.
                </p>
              </motion.div>
